...
public class Ipin extends RouteNode {
	...
	public Ipin(int index, int xlow, int xhigh, int ylow, int yhigh, int n, String portName, int portIndex, IndexedData indexedData, int numChildren) {
		super(index, xlow, xhigh, ylow, yhigh, n, 1, RouteNodeType.IPIN, 0, 0, indexedData, numChildren);
