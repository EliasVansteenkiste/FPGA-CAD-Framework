...
class GradientLegalizer extends Legalizer {
    ...
    private int overlap(){
    	...
    	if(timing) this.timer.time("Overlap");
    ...
    private void addVisual(){
		if(visual){
			...
			this.addVisual(String.format("gradient expand step %d", iteration), this.visualX, this.visualY);
