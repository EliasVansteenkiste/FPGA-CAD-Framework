...
public class TimingNode implements Comparable<TimingNode> {
    ...
    private Map<TimingNode, TimingEdge> sources = new HashMap<TimingNode, TimingEdge>();
    private Map<TimingNode, TimingEdge> sinks = new HashMap<TimingNode, TimingEdge>();
    ...
    Map<TimingNode, TimingEdge> getSourcesAndEdges() {
        return this.sources;
    }
