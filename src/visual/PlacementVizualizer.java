...
public class PlacementVizualizer {

    private static PlacementVizualizer instance = new PlacementVizualizer();
    public static PlacementVizualizer getInstance() {
        return PlacementVizualizer.instance;
    }


    private static enum NavigateDirection {PREVIOUS, NEXT};
    ...
    public void createAndDrawGUI() {
        ...
        this.frame = new JFrame("Placement vizualizer");
        ...
        this.placementPanel = new PlacementPanel();
    ...
    private class NavigateActionListener implements ActionListener{
        ...
        private PlacementVizualizer frame;
        private int step;

        NavigateActionListener(PlacementVizualizer frame, int step) {
            this.step = step;
            this.frame = frame;
        }
